...
def threat_description():
    ...
    prompt = f"""
Вы — эксперт по кибербезопасности. Объясните, что делает вредоносная программа и является ли программа вредоносной если нет то обьясни что это и для чего , обнаруженная антивирусом "{engine}".
Категория: {category}
Результат: {result}
